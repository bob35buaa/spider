...
| 文件 | 改动 |
|------|------|
| `spider/config.py` | +`contact_hdmi_ori_weight`, `palm_normal_left/right` |
| `spider/simulators/mjwp.py` | contact_hdmi_rew 块 + ori gating |
| `examples/config/override/core4d_e041.yaml` | E041 配置 |

## 结果路径

| 产出 | 路径 |
|------|------|
| box025 | `workspace/core4d/results/E041/E041_box025.{npz,mp4}` |
| bucket010 | `workspace/core4d/results/E041/E041_bucket010.{npz,mp4}` |
| 计划 | `workspace/core4d/plan/50_E041_orientation_reward_plan.md` |
| 配置 | `examples/config/override/core4d_e041.yaml` |
