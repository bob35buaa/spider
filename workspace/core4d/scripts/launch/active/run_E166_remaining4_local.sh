#!/usr/bin/env bash
# E166 remaining4 local CEM runner for A arm.
set -euo pipefail
...
LOGS="logs/E166/remaining4/cem/${STAGE}"
CASE_ARMS="${CASE_ARMS:-}"
...
echo "=== E166 remaining4 ${STAGE} local runner split=${E166_SPLIT} GPU=${LOCAL_GPU} ==="
if [ -n "$CASE_ARMS" ]; then
...
echo "=== E166 remaining4 ${STAGE} local runner complete; selected_rows=${row_count} ==="
