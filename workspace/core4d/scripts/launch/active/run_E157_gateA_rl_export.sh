#!/usr/bin/env bash
# E157: export selected E156 +gateA rows for downstream RL, including partner OmniRetarget.
set -euo pipefail
...
exec "$PYTHON_BIN" workspace/core4d/scripts/experiments/E157/export_gateA_rl_handoff.py \
  --execute-partner \
