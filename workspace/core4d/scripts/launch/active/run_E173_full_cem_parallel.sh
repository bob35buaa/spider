#!/usr/bin/env bash
# E173 Full CEM parallel driver (CPU-bound cases packed across GPUs).
#
# The per-GPU serial launcher (run_E173_local_8gpu_cem.sh) runs one case at a
...
#
# Usage: MAXJOBS=48 bash .../run_E173_full_cem_parallel.sh
set -uo pipefail
