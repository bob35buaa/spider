#!/usr/bin/env bash
# E174 Stage2b parallel retarget driver.
#
# The shared run_stage2b_queue.py runs cases SERIALLY. E174 has 56 move cases;
...
#
# Usage:
#   VARIANT=omnirt_v1 NSHARDS=24 bash .../run_E174_stage2b_parallel.sh
...
mkdir -p "$SHARD_ROOT" "logs/E174/stage2b/$VARIANT"
...
for sd in "$SHARD_ROOT"/shard*/; do
  ...
  [ -f "$sm" ] || continue
  sid=$(basename "$sd")
  log="logs/E174/stage2b/$VARIANT/${sid}.log"
