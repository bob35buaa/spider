#!/usr/bin/env bash
# E173 Full CEM视频渲染 — 全部 53 条 CEM-complete case 渲染 MP4（强制视觉复核，plan 8.3）。
#
...
#
# Usage: [NSHARDS=8] bash workspace/core4d/scripts/launch/active/run_E173_render_all.sh
set -uo pipefail
...
RUNNER=workspace/core4d/scripts/experiments/E173/render_cem_results.py
MANIFEST="$E/s6_downstream/manifests/cem_full_manifest.tsv"
LOGD="logs/E173/render/full"
mkdir -p "$LOGD"
