#!/usr/bin/env bash
# E161: export releaseDecay clean8 rows for downstream RL, including partner OmniRetarget.
set -euo pipefail
...
exec "$PYTHON_BIN" workspace/core4d/scripts/experiments/E161/export_releaseDecay_rl_handoff.py \
  --execute-partner \
