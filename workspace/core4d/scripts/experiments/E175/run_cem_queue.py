#!/usr/bin/env python3
"""E175 queue runner with production multi-geom runtime hard gates."""
...
SPEC = importlib.util.spec_from_file_location(
    "core4d_e175_cem_queue_runner", RUNNER
)
...
def compiled_pair_contract(
    ...
    if any(gid < 0 for gid in robot_ids.values()):
        raise ValueError("compiled model missing E175 robot object geom")
    if any(gid < 0 for gid in object_ids.values()):
        raise ValueError("compiled model missing E175 object geom")
