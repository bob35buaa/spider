#!/usr/bin/env python3
"""Build E159 gateA + surfaceBand-A2 clean6 manifest and overrides."""
...
SCRIPT_ROOT = REPO / "workspace/core4d/scripts/experiments/E159"
...
def write_surface_override(row: dict[str, Any], base_override: str) -> str:
    ...
    lines = [
        "# @package _global_",
        "# Auto-generated by workspace/core4d/scripts/experiments/E159/build_gate_surface_band_A2_manifest.py.",
        f"# E159 gateA+surfaceBand-A2 case={row['short_case_id']}.",
        "defaults:",
        f"  - {base_stem}",
        "  - _self_",
        "",
...
def build_row(case_id: str, gate_row: dict[str, str], ordinal: int) -> dict[str, Any]:
    variant = f"E159_{case_id}_gateA_surfaceBandA2"
    result_npz, outdir_npz, video = result_paths(variant)
    row: dict[str, Any] = {
        "ordinal": ordinal,
        "variant": variant,
        "short_case_id": case_id,
        "method": "gateA+surfaceBand-A2",
        "method_display": "gateA+surfaceBand-A2",
        "method_group": "surfaceBandA2",
        "run_status": "to_run",
        "source_exp": "E159",
...
def main() -> None:
    ...
    write_tsv(PREFLIGHT_ROOT / "e159_gate_surface_band_A2_preflight.tsv", preflight, PREFLIGHT_FIELDS)
    write_json(PREFLIGHT_ROOT / "e159_gate_surface_band_A2_preflight_summary.json", summary)
    print(
        "E159 manifest: "
