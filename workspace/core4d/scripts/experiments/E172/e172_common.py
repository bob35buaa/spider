#!/usr/bin/env python3
"""Shared contracts and filesystem helpers for E172 (Box004 full pipeline).

Single source of truth for E172 paths, data/env locations, frozen config values,
...
E172 forks the E171 (Box022/Box026) contract: same frozen algorithm (omnirt
...
RESULTS = REPO / "workspace/core4d/results/E172"
SCRIPT_DIR = REPO / "workspace/core4d/scripts/experiments/E172"
...
# --- Scope (box004 only; move-only production) -----------------------------
OBJECT_KEYS = ("box004",)
# Raw authority closes over ALL 20 person-case (10 seq); pass2/strike (6 pc) are
# Stage0 non-preferred rejects retained in the registry. Production candidate set
# is the 14 move person-case.
EXPECTED_PERSON_CASES = 20
EXPECTED_SEQUENCES = 10
EXPECTED_MOVE_PERSON_CASES = 14
EXPECTED_MOVE_SEQUENCES = 7
# historical prior only (NOT E172 authority); fresh S1 inventory is authority.
RAW_INVENTORY_PRIOR = {
    "box004": {
        "person_cases": 20,
        "sequences": 10,
        "dates": ("20231002", "20231003_2", "20231018"),
    },
}
