#!/usr/bin/env python3
"""E173: build the isolated omnirt_v2 canary and rescue inputs from fresh v1 results.
...
E168 builder this:
  * auto-selects an in-scope v1-pass canary (Box022/026), since E168's hardcoded
    bucket004 canary is out of E173 scope;
  * treats "0 infeasible rows" as a clean no-op (exit 0), because an all-v1-pass
    run is a valid E173 outcome, not an error.
