#!/usr/bin/env python3
"""Validate E176 CEM artifacts and write the canary/full runtime hard gate."""
...
def defaults(mode: str) -> tuple[Path, Path, int, str]:
    if mode == "canary":
        return (
            RESULT_ROOT / "manifests/lowgeom_canary_manifest.tsv",
            RESULT_ROOT / "cem/canary/canary_runtime_gate.json",
            6,
            "canary",
        )
    return (
        RESULT_ROOT / "manifests/lowgeom_full_manifest.tsv",
