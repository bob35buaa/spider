#!/usr/bin/env python3
"""Shared contracts and filesystem helpers for E171 (Box022/Box026 full pipeline).

Single source of truth for E171 paths, data/env locations, frozen config values,
...
RESULTS = REPO / "workspace/core4d/results/E171"
SCRIPT_DIR = REPO / "workspace/core4d/scripts/experiments/E171"
...
# --- Scope -----------------------------------------------------------------
OBJECT_KEYS = ("box022", "box026")
EXPECTED_PERSON_CASES = 60
EXPECTED_SEQUENCES = 30
# historical prior only (NOT E171 authority)
RAW_INVENTORY_PRIOR = {
    "box022": {"person_cases": 8, "sequences": 4, "dates": ("20231023",)},
    "box026": {"person_cases": 52, "sequences": 26, "dates": ("20231018", "20231020", "20231023")},
}
