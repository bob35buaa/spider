#!/usr/bin/env python3
"""Generate E081 Hydra overrides for leg/foot-object collision variants."""
...
# Auto-generated for E081 leg/foot-object collision validation.
defaults:
  - core4d_e074a_box023
  - _self_
...
# E081 keeps the E079/E080 main validation rule: no box023-specific hold window.
...
def main() -> None:
    ...
    parser.add_argument("--result-root", default="workspace/core4d/results/E081")
