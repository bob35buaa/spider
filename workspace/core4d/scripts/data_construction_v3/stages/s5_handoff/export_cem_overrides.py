...
def write_override(path: Path, row: dict[str, str], base_override: str, contact_source: str, target_path: str) -> None:
    ...
    for row in handoff_rows:
        ...
        if should_generate(row):
            ...
            if override_status == "pass":
                ...
                write_override(config_path, row, base_override, contact_source, yaml_target_path)
        rows.append(
            {
