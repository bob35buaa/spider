...
def build_rows(
    ...
    for row in registry_rows:
        ...
        candidate = {
            ...
            "contact_mask_label": row.get("contact_mask_label", ""),
            "contact_mask_person_idx": row.get("contact_mask_person_idx", ""),
            "contact_mask_time_axis": row.get("contact_mask_time_axis", ""),
            "contact_mask_3cm_npz": row.get("contact_mask_3cm_npz", ""),
            "contact_mask_5cm_npz": row.get("contact_mask_5cm_npz", ""),
            "raw_contact_artifact_npz": row.get("raw_contact_artifact_npz", ""),
            "raw_contact_3cm_artifact_npz": row.get("raw_contact_3cm_artifact_npz", ""),
            "raw_contact_5cm_artifact_npz": row.get("raw_contact_5cm_artifact_npz", ""),
            ...
            "contact_target_npz": row.get("contact_target_npz", ""),
            ...
            "contact_route_diagnostic_ref": row.get("contact_route_diagnostic_ref", ""),
        ...
        handoff_row = {
            **candidate,
            ...
            "contact_mask_npz": s4.get("contact_mask_npz", s3.get("contact_mask_npz", candidate.get("contact_mask_npz", ""))),
            "contact_mask_status": s4.get("contact_mask_status", s3.get("contact_mask_status", candidate.get("contact_mask_status", ""))),
            "contact_mask_label": s4.get("contact_mask_label", s3.get("contact_mask_label", candidate.get("contact_mask_label", ""))),
            "contact_mask_person_idx": s4.get("contact_mask_person_idx", s3.get("contact_mask_person_idx", candidate.get("contact_mask_person_idx", ""))),
            "contact_mask_time_axis": s4.get("contact_mask_time_axis", s3.get("contact_mask_time_axis", candidate.get("contact_mask_time_axis", ""))),
            "contact_mask_3cm_npz": candidate.get("contact_mask_3cm_npz", ""),
            "contact_mask_5cm_npz": candidate.get("contact_mask_5cm_npz", ""),
            "raw_contact_artifact_npz": s4.get("raw_contact_artifact_npz", s3.get("raw_contact_artifact_npz", candidate.get("raw_contact_artifact_npz", ""))),
            "raw_contact_3cm_artifact_npz": candidate.get("raw_contact_3cm_artifact_npz", ""),
            "raw_contact_5cm_artifact_npz": candidate.get("raw_contact_5cm_artifact_npz", ""),
            "raw_contact_time_axis": s4.get("raw_contact_time_axis", s3.get("raw_contact_time_axis", candidate.get("raw_contact_time_axis", ""))),
            "raw_to_trimmed_mapping_status": s4.get("raw_to_trimmed_mapping_status", s3.get("raw_to_trimmed_mapping_status", candidate.get("raw_to_trimmed_mapping_status", ""))),
            "contact_target_npz": s4.get("contact_target_npz", s3.get("contact_target_npz", candidate.get("contact_target_npz", ""))),
            "contact_target_source": s4.get("contact_target_source", s3.get("contact_target_source", candidate.get("contact_target_source", ""))),
            "contact_target_frame": s4.get("contact_target_frame", s3.get("contact_target_frame", candidate.get("contact_target_frame", ""))),
            "contact_target_time_axis": s4.get("contact_target_time_axis", s3.get("contact_target_time_axis", candidate.get("contact_target_time_axis", ""))),
            "contact_route_diagnostic_ref": s4.get("contact_route_diagnostic_ref", s3.get("contact_route_diagnostic_ref", candidate.get("contact_route_diagnostic_ref", ""))),
