#!/usr/bin/env python3
"""Generate E083 Hydra overrides for upper-body-object collision variants."""
...
# Auto-generated for E083 upper-body-object collision validation.
defaults:
  - core4d_e074a_box023
  - _self_
...
# E083A isolates collision-pair effects; no new reward penalty yet.
...
def main() -> None:
    ...
    parser.add_argument("--result-root", default="workspace/core4d/results/E083")
