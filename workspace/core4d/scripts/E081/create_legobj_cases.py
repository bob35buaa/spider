#!/usr/bin/env python3
"""Create E081 derived CORE4D tasks with leg/foot-object contact pairs.

This script never edits source tasks in-place. It copies each source task to a
new derived task directory and patches only the derived scene_act.xml.
"""
...
VARIANTS = REPO / "workspace/core4d/scripts/E081/variants.tsv"
...
def patch_scene_act(scene_act: Path, source_task: str, derived_task: str) -> list[str]:
    ...
    meta = {
        ...
        "added_pairs": added,
        "note": "E081 derived scene; source task scene_act.xml is not modified.",
    }
