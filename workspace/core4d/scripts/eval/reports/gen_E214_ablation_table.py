...
HOLOSOMA_FIELD = {  # report short key -> holosoma cache field (threshold sweeps)
    ...
    "cprec_holo_0p5": "contact_precision_holosoma_0.5cm",
    "cprec_holo_1": "contact_precision_holosoma_1cm",
...
METRICS = [
    ...
    ("cprec_holo_0p5","contact precision@0.5cm (holosoma SMPLX-GT)",  "higher", "pct"),
    ("cprec_holo_1", "contact precision@1cm (holosoma SMPLX-GT)",     "higher", "pct"),
