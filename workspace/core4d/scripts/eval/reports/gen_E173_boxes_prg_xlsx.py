#!/usr/bin/env python3
"""Generate the E173 PRG full-validation workbook (box024/box023/box001).

Adapted from gen_E170_box021_prg_xlsx.py. E173 is a cross-object screening
...
finding on the Overview. Consumes the canonical E173 eval TSVs + summary.json.
"""
...
DEFAULT_EVAL = Path("workspace/core4d/results/E173/s6_downstream/eval/full")
SHEETS = (
    ("Case Metrics", "e173_case_metrics.tsv"),
    ("Group Summary", "e173_group_summary.tsv"),
    ("Worst Cases", "e173_worst_cases.tsv"),
    ("Manual Review", "user_manual_review_template.tsv"),
    ("Codex Verification", "codex_verification.tsv"),
    ("Not Ready", "e173_not_ready.tsv"),
    ("Eval Errors", "e173_evaluation_errors.tsv"),
)
...
def main() -> int:
    ...
    output = args.output or eval_dir / "E173_boxes_prg_full_validation.xlsx"
    ...
    overview.append(["E173 PRG Full Validation — box024 / box023 / box001",
                     "Value", "Source / rule"])
