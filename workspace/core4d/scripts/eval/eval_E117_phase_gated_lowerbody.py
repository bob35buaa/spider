#!/usr/bin/env python3
"""Evaluate E117 phase/state-gated lower-body diagnostic outputs."""
...
E117_VARIANTS = REPO / "workspace/core4d/scripts/E117/variants.tsv"
...
def load_e115_eval():
    spec = importlib.util.spec_from_file_location("eval_E115_reused_for_E117", E115_EVAL)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"Could not load {E115_EVAL}")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    module.VARIANTS_TSV = E117_VARIANTS
    return module
...
def retitle_summary(path: Path) -> None:
    ...
    text = text.replace(
        ...
        "E117 Phase/State-Gated Lower-Body",
    )
...
def main() -> None:
    ...
    results_dir = repo_path_from_env(
        "RESULTS",
        args.results_dir or REPO / f"workspace/core4d/results/E117/cem/{args.stage}",
    )
