...
DEFAULT_MANIFEST = REPO / "workspace/core4d/results/E172/s6_downstream/manifests/cem_full_manifest.tsv"
DEFAULT_BASELINE = REPO / "workspace/core4d/results/E172/s6_downstream/eval/full/__no_baseline__.tsv"  # E172 has no paired A/B baseline (E106 is historical overlap only)
DEFAULT_OUT = REPO / "workspace/core4d/results/E172/s6_downstream/eval/full"
...
def recommendation(rows: list[dict[str, Any]]) -> dict[str, Any]:
    # E172 is fresh cross-object screening (no E168 paired baseline). Machine
