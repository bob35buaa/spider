...
DEFAULT_MANIFEST = REPO / "workspace/core4d/results/E173/s6_downstream/manifests/cem_full_manifest.tsv"
DEFAULT_BASELINE = REPO / "workspace/core4d/results/E173/s6_downstream/eval/full/__no_baseline__.tsv"  # E173 has no paired A/B baseline (E106 is historical overlap only)
DEFAULT_OUT = REPO / "workspace/core4d/results/E173/s6_downstream/eval/full"
...
def recommendation(rows: list[dict[str, Any]]) -> dict[str, Any]:
    # E173 is fresh cross-object screening (no E168 paired baseline). Machine
...
def main() -> int:
    ...
    write_tsv(out_dir / "e173_case_metrics.tsv", metrics, fields)
    write_tsv(out_dir / "e173_paired_deltas.tsv", paired)
    write_tsv(out_dir / "e173_group_summary.tsv", summaries)
    write_tsv(out_dir / "e173_worst_cases.tsv", rankings)
    write_tsv(out_dir / "e173_not_ready.tsv", not_ready)
    write_tsv(out_dir / "e173_evaluation_errors.tsv", errors)
