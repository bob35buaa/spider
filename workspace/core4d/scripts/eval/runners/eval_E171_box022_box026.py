...
DEFAULT_MANIFEST = REPO / "workspace/core4d/results/E171/s6_downstream/manifests/cem_full_manifest.tsv"
DEFAULT_BASELINE = REPO / "workspace/core4d/results/E171/s6_downstream/eval/full/__no_baseline__.tsv"  # E171 has no paired A/B baseline (E106 is historical overlap only)
DEFAULT_OUT = REPO / "workspace/core4d/results/E171/s6_downstream/eval/full"
...
def recommendation(rows: list[dict[str, Any]]) -> dict[str, Any]:
    # E171 is fresh cross-object screening (no E168 paired baseline). Machine
...
def main() -> int:
    ...
    write_tsv(out_dir / "e171_case_metrics.tsv", metrics, fields)
    write_tsv(out_dir / "e171_paired_deltas.tsv", paired)
    write_tsv(out_dir / "e171_group_summary.tsv", summaries)
    write_tsv(out_dir / "e171_worst_cases.tsv", rankings)
    write_tsv(out_dir / "e171_not_ready.tsv", not_ready)
    write_tsv(out_dir / "e171_evaluation_errors.tsv", errors)
