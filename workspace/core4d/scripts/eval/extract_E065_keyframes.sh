#!/usr/bin/env bash
# Extract dense keyframes for E065-A and E065-D on box023.
...
echo "=== E065A_box023 keyframes (pre-contact + carry + place) ==="
extract E065A_box023 "${BOX023_TS[@]}"
echo "=== E065D_box023 keyframes (pre-contact + carry + place) ==="
extract E065D_box023 "${BOX023_TS[@]}"

echo
echo "Total extracted: $(ls "$KF_DIR"/E065*_kf*.jpg 2>/dev/null | wc -l)"
