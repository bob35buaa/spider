#!/usr/bin/env python3
"""Evaluate E119 upright-carry support-guard diagnostic outputs."""
...
def load_e115_eval():
    spec = importlib.util.spec_from_file_location("eval_E115_reused_for_E119", E115_EVAL)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"Could not load {E115_EVAL}")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    module.VARIANTS_TSV = E119_VARIANTS
    return module
...
def main() -> None:
    ...
    results_dir = repo_path_from_env(
        "RESULTS",
        args.results_dir or REPO / f"workspace/core4d/results/E119/cem/{args.stage}",
    )
