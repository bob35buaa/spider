#!/usr/bin/env python3
"""E067 evaluation — task_obj_rew form ablation on box023.
...
Also writes:
  workspace/core4d/results/E067/eval_summary.csv
  workspace/core4d/results/E067/foot_z_trace_E067N_box023.png
  workspace/core4d/results/E067/foot_z_trace_E067NS_box023.png
  workspace/core4d/results/E067/pelvis_obj_E067N_box023.png  (vs E062 baseline)
  workspace/core4d/results/E067/pelvis_obj_E067NS_box023.png

Reads:
  workspace/core4d/results/E067/E065{A,D}_box023.npz
...
RESULTS = REPO / "workspace/core4d/results/E067"
...
def main() -> None:
    ...
    print()
    print("=" * 70)
    print("E067 PASS criteria (log 83 §4.3):")
    for cfg, r in e065_rows:
