#!/usr/bin/env python3
"""E065 evaluation — task_obj_rew form ablation on box023.
...
Also writes:
  workspace/core4d/results/E065/eval_summary.csv
  workspace/core4d/results/E065/foot_z_trace_E065A_box023.png
  workspace/core4d/results/E065/foot_z_trace_E065D_box023.png
  workspace/core4d/results/E065/pelvis_obj_E065A_box023.png  (vs E062 baseline)
  workspace/core4d/results/E065/pelvis_obj_E065D_box023.png

Reads:
  workspace/core4d/results/E065/E065{A,D}_box023.npz
...
RESULTS = REPO / "workspace/core4d/results/E065"
...
def main() -> None:
    ...
    print()
    print("=" * 70)
    print("E065 PASS criteria (log 83 §4.3):")
    for cfg, r in e065_rows:
