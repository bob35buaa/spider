#!/usr/bin/env python3
"""Evaluate E121 terminal carry gate diagnostic outputs."""
...
def load_e115_eval():
    module = load_module("eval_E115_reused_for_E121", E115_EVAL)
    module.VARIANTS_TSV = E121_VARIANTS
    return module


def load_e105_eval():
    return load_module("eval_E105_for_E121", E105_EVAL)
...
def main() -> None:
    ...
    results_dir = repo_path_from_env(
        "RESULTS",
        args.results_dir or REPO / f"workspace/core4d/results/E121/cem/{args.stage}",
    )
