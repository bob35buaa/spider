...
OUT_DIR="${OUT_DIR:-$REPO/workspace/core4d/results/E109/fair_eval_existing_cases_only}"
...
echo "[run_existing_cases_only_eval] outputs written to $OUT_DIR"
