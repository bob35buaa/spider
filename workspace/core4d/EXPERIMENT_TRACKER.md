...
| Run | 日期 | Phase | 描述 | 状态 |
|-----|------|-------|------|------|
| E081 | 2026-05-16 | Phase 18 | **leg/foot-object collision 派生 scene 验证**: 不改原始 `scene_act.xml`，新建 `box025_person2_legobj` 与 `box023_person2_legobj` 派生任务，在派生 `scene_act.xml` 中追加 16 个腿/脚-`object_collision` pair。box025_p2 作为 E080 partial positive 本地跑，box023_p2 作为 E078/E079 guard 远程 GPU1 跑；eval 新增 leg-box SDF/interference、leg-object contact、object floor/lift proxy | 🚧 setup/smoke |
...
- 📋 E081 plan/setup: 按用户要求不直接修改原始 scene，新建 `*_legobj` 派生任务；`box025_person2_legobj` 和 `box023_person2_legobj` 均追加 16 个腿/脚-箱 contact pair，两个短 horizon smoke 已通过。下一步提交推送后启动本地 box025_p2 + 远程 GPU1 box023_p2: `workspace/core4d/plan/86_E081_leg_object_collision_eval_plan.md`
