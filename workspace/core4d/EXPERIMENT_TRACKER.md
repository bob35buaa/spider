...
|-----|------|-------|------|------|-----|
| E156 | 2026-06-12 | Phase 27 | clean8 三方法 benchmark: rubberhand / +gateA / decay | ✅ 13/13 new full + 24/24 strict eval；tracking 8/8；`decay` 接触↑但 false/穿透↑，不升级默认；保留 `+gateA` | [197](log/197_E156_clean8_gate_decay_benchmark_results.md) |
