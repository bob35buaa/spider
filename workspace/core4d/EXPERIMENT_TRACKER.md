...
|-----|------|-------|------|------|-----|
| R295 | 2026-09-05 | Phase 68 | E209 desk/chair PRG+G1：E206 PRG + 仅 object gravcomp 单变量(22 交付case, A0 hand-gate, 1024×32 seed0, 基线零重跑) | 📝 计划态，P0 过(基线冻结 8/8 检查 + 132 文件补 rules§7 保障1)。desk/chair z 下沉 **−2.517cm 比 bucket −1.820 更重**(18/22, r=−0.738)。**科学价值=裁定 gravcomp 传递函数**：E207 的「+1.945cm 常量」有质量/pre-bias 双重共线(mass=2→+1.691 n=7, mass=5→+2.836 n=2)，E209 全 22 例 mass=5.000kg 零方差而 pre-bias 跨 −5.65…+2.67，7 例判别 case 分离 5.6–9.0σ | [plan239](plan/239_E209_desk_chair_prg_g1_gravcomp_plan.md) |
