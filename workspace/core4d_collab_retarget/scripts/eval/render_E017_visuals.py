#!/usr/bin/env python3
"""Render E017 comparison videos and contact sheets.

E017 uses a soft weld to a moving mocap support body. A generic qpos-only
