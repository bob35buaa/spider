#!/usr/bin/env python3
"""Render E018 comparison videos and contact sheets.

E018 uses a soft weld to a moving mocap support body. A generic qpos-only
...
def render_comparison(
    ...
    *,
    ...
    if support_pos is None:
        raise ValueError(f"{phys} does not contain support_proxy_pos; E018 render would be misleading")
