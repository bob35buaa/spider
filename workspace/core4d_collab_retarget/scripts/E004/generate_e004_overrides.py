#!/usr/bin/env python3
"""Generate E004 Hydra overrides for freejoint virtual-partner support."""
...
# Auto-generated for E004 true-freejoint virtual partner support.
defaults:
  - core4d_e074a_box023
  - _self_
...
def main() -> None:
    ...
    parser.add_argument("--result-root", default="workspace/core4d_collab_retarget/results/E004")
    args = parser.parse_args()

    for row in read_variants(args.variants):
        if row["queue"] == "probe":
            print(f"[SKIP] {row['variant']} queue=probe")
            continue
