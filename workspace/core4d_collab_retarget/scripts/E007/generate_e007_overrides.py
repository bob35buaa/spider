#!/usr/bin/env python3
"""Generate E007 Hydra overrides for COLA-style support proxy variants."""
...
VARIANTS = REPO / "workspace/core4d_collab_retarget/scripts/E007/variants.tsv"
...
# Auto-generated for E007 COLA-style support-body proxy.
defaults:
  - core4d_e074a_box023
  - _self_
...
def main() -> None:
    ...
    parser.add_argument(
        "--result-root", default="workspace/core4d_collab_retarget/results/E007"
    )
