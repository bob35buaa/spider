#!/usr/bin/env python3
"""Generate E014 Hydra overrides for COLA-B soft-weld support anchors."""
...
# Auto-generated for E014 COLA-B kinematic support + soft weld.
defaults:
  - core4d_e074a_box023
  - _self_
...
def main() -> None:
    ...
    parser.add_argument(
        "--result-root", default="workspace/core4d_collab_retarget/results/E014"
    )
