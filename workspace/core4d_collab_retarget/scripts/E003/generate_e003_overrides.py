#!/usr/bin/env python3
"""Generate E003 Hydra overrides for true-freejoint physics-sweep variants."""
...
# Auto-generated for E003 true-freejoint physics feasibility sweep.
defaults:
  - core4d_e074a_box023
  - _self_
...
def main() -> None:
    ...
    parser.add_argument("--result-root", default="workspace/core4d_collab_retarget/results/E003")
