#!/usr/bin/env python3
"""Generate E011 Hydra overrides for soft object tether diagnostics."""
...
VARIANTS = REPO / "workspace/core4d_collab_retarget/scripts/E011/variants.tsv"
...
def generate_override(row: dict[str, str], result_root: str) -> Path:
    ...
    support_mode = "wrench" if support_enabled else "wrench"

    override_name = f"core4d_collab_{variant}"
    path = OUT_DIR / f"{override_name}.yaml"
    content = f"""# @package _global_
# Auto-generated for E011 soft object tether diagnostic.
defaults:
  - core4d_e074a_box023
  - _self_
...
support_proxy_mode: {support_mode}
...
def main() -> None:
    ...
    parser.add_argument(
        "--result-root", default="workspace/core4d_collab_retarget/results/E011"
    )
