...
| E003 | 2026-05-17 | Physics Feasibility | **true-freejoint 物理参数可行性 sweep 计划**: 在 E002 基础上改 object mass/friction，区分“物理参数导致不可行”与“reward/optimizer 本身不足”；计划使用远程双卡并行 | 📋 计划中 |
