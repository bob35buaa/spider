...
| E029 | 2026-05-27 | COLA Support Body Redesign | **COLA-style D6 support body 规划**: 复核确认 E018/E028 是 `mocap_pad` kinematic support anchor + soft weld，不是 COLA dynamic support body；E015 dynamic prototype 工程通过但 lag/clamp/NaN。结合 COLA 论文与 Holosoma r051-r056，后续改为 dynamic support body + D6-equivalent support-object constraint，并先对 E028 `candidates.json` 5 条做 axis/contact preflight 与 no-training D6 load-path sanity，sanity 过后才 full retarget | 📝 详见 plan 34 |
...
| E029 plan | 当前 E018/E028/E028b=`mocap_pad` + mocap `support_weld_anchor` + equality weld；COLA/Holosoma 证据要求 dynamic support body + D6 support-object load path；Holosoma r052/r052b/r052c joint-connected sanity 通过，r053-r055 是轴向 bug | 不继续把 E028b anchor refit 作为主线；先做 5-case axis/contact preflight 和 D6 no-training sanity，再决定是否 full |
